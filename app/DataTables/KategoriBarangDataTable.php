...
class KategoriBarangDataTable extends DataTable
{
     ...
     */
    public function query(KategoriBarang $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('kategoribarang-table')
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('kategori')->title('Kategori')->addClass('align-middle'),
    ...
    {
        return 'KategoriBarang_' . date('YmdHis');
    }
}
