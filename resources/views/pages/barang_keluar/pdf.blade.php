...
<html>
<head>
    <title>Transaksi {{ $barangKeluar->kode_transaksi }}</title>
    <style>
...
<body>
    <div class="header">
        ...
        <p style="margin:5px 0;">No. Transaksi: {{ $barangKeluar->no_transaksi }}</p>
    </div>
    ...
    <table class="info-table">
        <tr>
            ...
            <td width="2%">:</td>
            <td width="33%">{{ $barangKeluar->created_at->format('d F Y') }}</td>
            <td width="15%">Admin</td>
            <td width="2%">:</td>
            <td width="33%">{{ $barangKeluar->admin->name ?? '-' }}</td>
        </tr>
        <tr>
            <td>Keterangan</td>
            <td>:</td>
            <td colspan="4">{{ $barangKeluar->keterangan ?? '-' }}</td>
        </tr>
    </table>
