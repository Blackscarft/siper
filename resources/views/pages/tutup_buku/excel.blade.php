<table>
    ...
    <thead>
        <tr>
            <th colspan="3" style="font-weight: bold; font-size: 14px;">REKAPITULASI STOK BULANAN</th>
        </tr>
        <tr>
            <th colspan="3">Periode: {{ $namaBulan }} {{ $tahun }}</th>
        </tr>
        <tr></tr> <!-- Baris kosong -->
        <tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="border: 1px solid #000;">{{ $item->stok_akhir ?? 0 }}</td>
        </tr>
        @endforeach
    </tbody>
</table>